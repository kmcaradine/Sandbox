...
public class SearchLabels extends SharedCode {
    ...
    public void SearchLabelsTest(String tcName, int repositoryId ,String lang, String sort, String order,
        ...
        if(repositoryId > 0){
            requestSpecBuilder.addQueryParam("repository_id", repositoryId);
        }
